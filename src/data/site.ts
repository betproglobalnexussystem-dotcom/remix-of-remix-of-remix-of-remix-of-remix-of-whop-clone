export const MONTHLY_PLAN_ID = "plan_Fa7Dz3p706u3N";
export const ANNUAL_PLAN_ID = "plan_t1FtxvdLRFI5i";
...
export const POPULAR_TOPICS = [
	{ label: "ZEN", to: "/article/tag/zen" },
	{ label: "TRAUMA", to: "/article/tag/trauma" },
	{ label: "TAOISM", to: "/article/tag/taoism" },
	{ label: "TANTRA", to: "/article/tag/tantra" },
	{ label: "SUFISM", to: "/article/tag/sufism" },
	{ label: "SOCIETY", to: "/article/tag/society" },
	{ label: "SOCIAL ACTION", to: "/article/tag/social-action" },
	{ label: "SHAMANISM", to: "/article/tag/shamanism" },
	{ label: "SCIENCE", to: "/article/tag/science" },
	{ label: "QUANTUM PHYSICS", to: "/article/tag/quantum-physics" },
] as const;
...
export const FOOTER_LEGAL = [
	{ label: "Recording Policy", to: "/recording-policy" },
